namespace pk3DS
{
    partial class MoveEditor6
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.NUD_Effect);
            this.Controls.Add(this.NUD_Inflict);
            this.Controls.Add(this.L_Inflict);
            this.Controls.Add(this.CB_Inflict);
            this.Controls.Add(this.CB_Targeting);
            this.Controls.Add(this.RTB);
            this.Controls.Add(this.L_Targeting);
            this.Controls.Add(this.L_Influcts);
            this.Controls.Add(this.GB_Stat);
            this.Controls.Add(this.NUD_Recoil);
            this.Controls.Add(this.L_Recoil);
            this.Controls.Add(this.NUD_Heal);
            this.Controls.Add(this.L_Heal);
